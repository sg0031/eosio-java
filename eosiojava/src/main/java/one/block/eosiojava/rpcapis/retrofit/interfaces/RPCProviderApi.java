...
public interface RPCProviderApi {
     ...
     * This method gets called from {@link RPCProviderImpl#getInfo()} to get latest information about the pointing chain.
     *
     ...
     * This method gets called from {@link RPCProviderImpl#getBlock(GetBlockRequest)} to get info/status of a specific block in the request.
     *
     ...
     * This method gets called from {@link RPCProviderImpl#getRawAbi(GetRawAbiRequest)} to get serialized ABI of a smart contract in the request.
     *
     ...
     * This method gets called from {@link RPCProviderImpl#getRequiredKeys(GetRequiredKeysRequest)} to get required keys to sign a transaction
     *
     ...
     * This method gets called from {@link RPCProviderImpl#pushTransaction(PushTransactionRequest)} to Push transaction RPC call to broadcast a transaction to backend
     *
     ...
     * This method gets called from {@link RPCProviderImpl#getAccount(RequestBody)}
     *
     ...
     * This method gets called from {@link RPCProviderImpl#pushTransactions(RequestBody)}
     *
     ...
     * This method get called from {@link RPCProviderImpl#getBlockHeaderState(RequestBody)}
     *
     ...
     * This method gets called from {@link RPCProviderImpl#getAbi(RequestBody)}
     *
     ...
     * This method gets called from {@link RPCProviderImpl#getCurrencyBalance(RequestBody)}
     *
     ...
     * This method gets called from {@link RPCProviderImpl#getCurrencyStats(RequestBody)}
     *
     ...
     * This method gets called from {@link RPCProviderImpl#getProducers(RequestBody)}
     *
     ...
     * This method gets called from {@link RPCProviderImpl#getRawCodeAndAbi(RequestBody)}
     *
     ...
     * This method gets called from {@link RPCProviderImpl#getTableRows(RequestBody)}
     *
     ...
     * This method gets called from {@link RPCProviderImpl#getCode(RequestBody)}
     *
     ...
     * This method gets called from {@link RPCProviderImpl#getKeyAccounts(RequestBody)}
     *
     ...
     * This method gets called from {@link RPCProviderImpl#getControlledAccounts(RequestBody)}
     *
